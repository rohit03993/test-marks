            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink :href="route('quick-upload.index')" :active="route().current('quick-upload.*')">
                                    Quick Upload
                                </NavLink>
                            </div>
                        </div>
                            ...
                            <div class="ms-3 relative">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <DropdownLink :href="route('reset.index')" class="text-red-600 hover:text-red-700">
                                            Reset All Data
                                        </DropdownLink>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('quick-upload.index')" :active="route().current('quick-upload.*')">
                            Quick Upload
                        </ResponsiveNavLink>
                    </div>
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            <ResponsiveNavLink :href="route('reset.index')" :active="route().current('reset.*')" class="text-red-600">
                                Reset All Data
                            </ResponsiveNavLink>
